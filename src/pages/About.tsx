...
const About: React.FC = () => {
  return (
    <div className="w-full bg-dark-bg text-white flex flex-col font-sans">
      ...
      {/* 1. Header Section */}
      <section
        className="relative min-h-[100dvh] flex flex-col items-center justify-center text-center px-4 pt-16 overflow-hidden"
        style={{
      ...
      {/* 2. Manifesto Section */}
      <section className="w-full border-y border-white/5 px-6 md:px-16 py-24 md:py-40">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-16 md:gap-24">
          ...
          <div className="flex-shrink-0 flex flex-col gap-3">
            ...
            />
            <div className="text-white font-semibold text-lg">홍 찬 호</div>
            <div className="text-gray-300 font-mono text-base tracking-widest font-medium">1993.02.15</div>
          </div>

          {/* 오른쪽: 텍스트 */}
          <div className="w-full md:w-3/5 text-lg md:text-xl lg:text-2xl text-gray-300 leading-[2.0] md:leading-[2.2] font-normal break-keep space-y-10 md:space-y-14 text-right">
            <p>
            ...
            <p>
              익숙한 <span className="text-white font-semibold">"과거"</span>를 내려놓고 로보틱스 엔지니어로의 길을 걷고 있는 지금,
